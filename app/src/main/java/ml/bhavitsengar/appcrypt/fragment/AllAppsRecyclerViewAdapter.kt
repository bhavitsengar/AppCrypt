...
import ml.bhavitsengar.appcrypt.fragment.AllAppsFragment.OnListFragmentInteractionListener
...
class AllAppsRecyclerViewAdapter(
    ...
    : RecyclerView.Adapter<AllAppsRecyclerViewAdapter.ViewHolder>(), Filterable {
